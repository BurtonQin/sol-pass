// This file is adapted from `github.com/llvm-tutor`
//
//==============================================================================
// FILE:
...
// USAGE:
//    1. Legacy PM
//      opt -load libStaticCallCounter.so -enable-new-pm=0 --legacy-static-cc `\`
//        -analyze <input-llvm-file>
//    2. New PM
//      opt -load-pass-plugin libStaticCallCounter.so `\`
//        -passes="print<static-cc>" `\`
//        -disable-output <input-llvm-file>
//
// License: MIT
//==============================================================================
#include "analysis/StaticCallCounter.h"
...
static void printStaticCCResult(raw_ostream &OutS,
  ...
  OutS << "================================================="
       << "\n";
  OutS << "sol-pass: static analysis results\n";
  OutS << "=================================================\n";
